...
<head>
    ...
    <!-- Vite build output, adjust path if needed -->
    <script type="module" src="./main.js"></script>
</head>
<body>
    <div id="app">
        <!-- Todo el contenido original se encuentra aquí, Vue puede controlar este contenedor -->
        <div class="container">
            <nav>
                <div class="logo">
                    <img src="../../public/images/Logosimbolo-SENA.svg" alt="SENA Logo">
                    <a href="#">SOE | SENA</a>
                </div>
                <div class="menu-items">
                    ...
                    <a href="#">Noticias</a>
                    <a href="#">Contacto</a>
                    <a href="#" class="btn">Estudia con Nosotros</a>
                </div>
            </nav>
            <!--hero section-->
            <header>
                ...
                <div class="right">
                    <img src="../../images/hero-image.png" alt="Education Illustration">
        ...
        <div class="featured">
            <div class="container">
                ...
                <div class="logos">
                    <img src="../../images/airbnb-logo.svg" alt="Logo 1">
                    <img src="../../images/spotify-logo.svg" alt="Logo 2">
                    <img src="../../images/google-logo.svg" alt="Logo 3">
                    <img src="../../images/canva-logo.svg" alt="Logo 4">
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="left">
                    ...
                    <div class="features-container">
                        <div class="feature">
                            <div class="icon">
                                <img src="../../images/check-icon.svg" alt="Mission Icon">
                            </div>
                        ...
                        <div class="feature">
                            <div class="icon">
                                <img src="../../images/check-icon.svg" alt="Flexible Learning Icon">
                            </div>
                        ...
                        <div class="feature">
                            <div class="icon">
                                <img src="../../images/check-icon.svg" alt="Support Icon">
                            </div>
                        ...
                        <div class="feature">
                            <div class="icon">
                                <img src="../../images/check-icon.svg" alt="Community Icon">
                            </div>
        ...
        <section id="why">
            <div class="container">
                <div class="left">
                    <img src="../../images/image2.png" alt="About Illustration">
                </div>
                <div class="right">
                    ...
                    <a href="#" class="btn light">Contactanos</a>
                </div>
            </div>
        </section>
        ...
        <div class="contact">
            <div class="container">
                <div class="heading-container">
                    ...
                    <a href="#" class="btn">Contáctanos Hoy</a>
                </div>
                <form action="#">
                    <div class="group">
